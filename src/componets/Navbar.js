      ...
      <div className="collapse navbar-collapse" id="navbarSupportedContent">
        <ul className="navbar-nav me-auto mb-2 mb-lg-0">
          <li className="nav-item">
            <Link className="nav-link active" aria-current="page" to="/text">{props.aboutus}</Link>
          </li>
          <li className="nav-item">
       <Link className="nav-link active" aria-current="page" to="/about">About</Link>
          ...
          <li className="nav-item">
            <a className="nav-link disabled" href="/" tabindex="-1" aria-disabled="true">{props.active}</a>
          </li>
        </ul>
...
// Navbar.defaultProps = {title: "set title", aboutus: "set about us"}
// Navbar.propTypes = {
